...
bot = TeleBot(token='6073924236:AAHAWhxYfM12wrlnHB6ZgwfRlKWzn8qzTMI', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я умею генерировать тестовые банковские карты для тестирования оплаты\nВыбери тип карты:', # текст сообщения
